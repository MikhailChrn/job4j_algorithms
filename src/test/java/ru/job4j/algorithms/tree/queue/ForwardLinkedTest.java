...
class ForwardLinkedTest {
    ...
    @Test
    void whenRequestListFromForworedLinkedListThenGetIt() {
        list.add(3);
        list.add(4);
        List<Integer> integerList = list.toList();
        assertThat(integerList.size()).isEqualTo(4);
        assertTrue(integerList.containsAll(List.of(3, 1, 2, 4)));
        assertThat(integerList).containsExactlyInAnyOrder(1, 2, 3, 4);
    }
}